    ...
    <div className="bg-gray-800 rounded-lg overflow-hidden mb-16 custom-shadow">
      <div className="md:flex">
        ...
        <div className="md:w-1/2 p-8 md:p-10 flex flex-col justify-center">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-white">5 Digital Marketing Trends Reshaping the Industry in 2025</h2>
          ...
          <Link to="/blog/digital-marketing-trends-2025" className="inline-flex items-center text-primary font-medium hover:text-white transition-colors">
            Read Full Article
