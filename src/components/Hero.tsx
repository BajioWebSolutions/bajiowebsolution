...
export const Hero = () => {
  return (
    <div className="relative min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-background via-neutral-dark/40 to-primary/10">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-primary/10 via-accent/5 to-transparent opacity-50"></div>
      <div className="container mx-auto px-4 py-20 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-up">
          <Button
            asChild
            className="bg-primary hover:bg-primary-dark text-background text-lg px-8 py-6 transition-all duration-300 hover:scale-105"
          >
          ...
          <Button
            asChild
            variant="outline"
            className="text-foreground border-foreground hover:bg-foreground/10 text-lg px-8 py-6 transition-all duration-300 hover:scale-105"
          >
