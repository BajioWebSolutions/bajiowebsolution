...
export const ServicePage = () => {
  ...
  if (!serviceId) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-background via-neutral-dark/40 to-primary/5 py-20">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-neutral-dark/40 to-primary/5 py-20 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-neutral-dark/20 rounded-lg p-8 backdrop-blur-sm">
