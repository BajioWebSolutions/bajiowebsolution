...
const OurStoryPage = () => {
  return (
    <>
      <SEO 
        title="Our Story - Bajio Web Solutions"
        description="Learn about the founder and mission behind Bajio Web Solutions, Connecticut's premier digital agency helping local businesses grow online."
        canonical="/our-story"
      />
              ...
              <div className="mb-12">
                <div className="w-48 h-48 mx-auto rounded-full bg-gradient-to-br from-primary/20 to-primary/10 border-4 border-primary/30 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-primary font-medium">Professional Headshot</p>
              ...
              <div className="space-y-8 text-white/90">
                ...
                <div className="text-center pt-12">
                  <motion.a
                    ...
                    className="inline-flex items-center justify-center px-10 py-4 bg-gradient-to-r from-primary to-primary-light hover:from-primary-light hover:to-primary text-white font-bold text-xl rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/30"
